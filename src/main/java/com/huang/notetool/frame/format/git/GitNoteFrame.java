...
// * @date 2019-06-19
// */
//public class GitNoteFrame extends JRootParentFrame implements Runnable {
//    private static final int INITIAL_TABLE_ROW_NUM = 30;
//    /**
//     * 日志
//     */
//    private Logger logger = Logger.getLogger(GitNoteFrame.class);
//    /**
//     * Service
//     */
...
//     * @param ignored 忽略
//     */
//    public GitNoteFrame(String ignored) {
//        logger.info("初始化显示面板");
...
//
//        return e -> {
//            addLinuxCmdFrame addLinuxCmdFrame = new addLinuxCmdFrame(GitNoteFrame.this);
...
//                new ShowMsgSinglePanel(returnMsg, GitNoteFrame.this);
//                refreshData();
//            }
//        };
//    }
...
//                        JOptionPane.showMessageDialog(GitNoteFrame.this, "删除失败，请重新选中此行");
//                        return;
//                    }
//                    logger.info("即将进行删除操作");
//                    //1:否  2:取消  0:确定
//                    int result = JOptionPane.showConfirmDialog(GitNoteFrame.this, "确定删除？");
//                    if (result == 0) {
//                        if (!linuxCmdService.deleteById(id)) {
//                            logger.warn("删除Linux命令失败[[ id=" + id);
//                            JOptionPane.showMessageDialog(GitNoteFrame.this, "删除失败");
//                            return;
//                        }
//                        logger.warn("删除Linux命令成功[[ id=" + id);
//                        JOptionPane.showMessageDialog(GitNoteFrame.this, "删除成功");
//                        refreshData();
...
//                    JOptionPane.showMessageDialog(GitNoteFrame.this, "查看Linux命令失败，请重新选中此行");
//                    return;
//                }
//                //需要新增按钮事件
